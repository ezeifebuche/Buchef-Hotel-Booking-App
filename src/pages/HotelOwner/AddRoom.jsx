...
const AddRoom = () => {
  ...
  return (
    <form >
      <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully and accurately, pricing,
      and amenities, to enhance the user booking experience. Thank you!'/>
      ...
      <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
        {Object.keys(inputs.amenities).map((amenity, index)=>(
          <div key={index}>
              ...
              onChange={()=>setInputs({...inputs, amenities: {...inputs.amenities,
