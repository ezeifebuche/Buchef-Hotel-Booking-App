...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        <Title title='My Bookings' subTitles='Easily manage your past, current and upcoming hotel reservation
        in one place. Plan your trips seamlessly with just a few clicks' align='left' />

        <div className='max-w-6xl mt-full text-gray-800'>
            ...
            {bookings.map((booking)=>(
                ...
                w-full border-b border-gray-300 py-6 first:border-t'>
                    ...
                    {/*...payment status..*/}
                    <div className='flex flex-col items-startjustify-center pt-3'>
